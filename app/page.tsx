  ...
  return (
    <main>
                      ...
                      <div className="space-y-10">
                        ...
                        <div className="relative flex items-start gap-5">
                          ...
                          <div className="flex-1 pt-2">
                            ...
                            <p className="text-base text-white/80">Atlassian ürünlerinin kurulumu ve özelleştirilmesi</p>
                          </div>
                        </div>
                        ...
                        <div className="relative flex items-start gap-5">
                          ...
                          <div className="flex-1 pt-2">
                            ...
                            <p className="text-base text-white/80">Kullanıcı ve yönetici eğitimi, süreç dokümantasyonu</p>
                          </div>
                        </div>
                        ...
                        <div className="relative flex items-start gap-5">
                          ...
                          <div className="flex-1 pt-2">
                            ...
                            <p className="text-base text-white/80">Farklı SLA seviyelerinde teknik destek ve optimizasyon</p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              İşletmenizi bir üst seviyeye taşımak için ihtiyacınız olan tüm dijital çözümler tek çatı altında.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    Modern teknolojilerle işletmenizi hızla dijitalleştiriyor ve süreçlerinizi optimize ediyoruz.
                  </p>
            ...
            <div className="group relative bg-white p-8 rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:-translate-y-1 border border-gray-100 w-5/6 mx-auto lg:w-full">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-[#253858] mb-4">Atlassian En İyi Uygulamaları</h3>
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    Atlassian'ın önerdiği en iyi uygulamaları ve yöntemleri kullanarak projelerinizi doğru şekilde yönetmenize yardımcı oluyoruz.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#0052CC] mt-1 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-600">Düzgün yapılandırılmış iş akışları</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#0052CC] mt-1 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-600">Verimli proje yönetimi metodolojileri</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="group relative bg-white p-8 rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:-translate-y-1 border border-gray-100 w-5/6 mx-auto lg:w-full">
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    Atlassian tarafından onaylanmış Atlassian sertifikalı danışmanlarımızla, projenizin her aşamasında yanınızdayız.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#0052CC] mt-1 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-600">Atlassian araçlarında derin deneyim</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#0052CC] mt-1 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-600">Kurumsal seviye proje deneyimi</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="relative h-full bg-black/20 backdrop-blur-xl rounded-3xl p-10 border border-white/10 overflow-hidden transform transition-transform duration-500 hover:scale-[1.02] flex flex-col justify-center">
                  ...
                  <div className="flex flex-col items-center justify-start">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <span className="text-2xl font-extrabold bg-gradient-to-r from-[#FF8E53] via-white to-[#FF6B6B] bg-clip-text text-transparent drop-shadow text-center leading-none">Kurumsal Müşteriler</span>
                    </div>
                    ...
                    <p className="text-lg text-white/90 font-semibold mt-6 text-center">Yerel ve uluslararası şirketler için Atlassian çözümleri</p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative h-full bg-black/20 backdrop-blur-xl rounded-3xl p-10 border border-white/10 overflow-hidden transform transition-transform duration-500 hover:scale-[1.02] flex flex-col justify-center">
                  ...
                  <div className="flex flex-col items-center justify-start">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <span className="text-2xl font-extrabold bg-gradient-to-r from-[#EC4899] via-white to-[#7C3AED] bg-clip-text text-transparent drop-shadow text-center leading-none">Başarılı Projeler</span>
                    </div>
                    <div className="flex flex-row items-center justify-center mb-2 gap-1">
                    ...
                    <p className="text-lg text-white/90 font-semibold mt-6 text-center">Tamamlanan başarılı projeler</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 overflow-hidden">
                ...
                <blockquote className="text-center mb-8">
                  <p className="text-lg md:text-xl text-[#172B4D] leading-relaxed font-normal italic">
                    "Birlikte çalıştığımız Jira Service Management projesi için teşekkür ederim. Özellikle Asset geliştirmeleri oldukça faydalı oldu. Yeni projelerde çalışmak dileğiyle..."
                  </p>
                </blockquote>

                {/* Author */}
                <div className="text-center">
                  <p className="text-base font-semibold text-[#42526E]">
                    Sinan D.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 mb-6">
              Ücretsiz analiz hizmetimizle işletmeniz için en uygun çözümleri birlikte belirleyelim.
            </p>
            <div className="flex justify-center">
              <Link href="/free-discovery" className="group relative px-6 py-3 rounded-xl font-medium transition-all scale-105 hover:scale-110">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all w-full mx-auto">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-semibold text-[#253858] mb-3">Atlassian Danışmanlık</h3>
                <p className="text-[#42526E] mb-4">Jira, Confluence ve diğer Atlassian ürünleri ile iş süreçlerinizi optimize edin. Uzman ekibimiz, organizasyonunuz için özel yapılandırma, entegrasyon ve süreç iyileştirme çözümleri sunar.</p>
                <Link href="/solutions/consulting" className="inline-flex items-center text-[#0052CC] font-medium hover:underline">
                  Daha Fazla Bilgi
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all w-full mx-auto">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-semibold text-[#253858] mb-3">Bulut Geçişi</h3>
                <p className="text-[#42526E] mb-4">Şirket içi Atlassian ürünlerinizi sorunsuz bir şekilde Bulut ortamına geçirin. Güvenli veri geçişi, kullanıcı yönetimi ve entegrasyonlar için uçtan uca destek sağlıyoruz.</p>
                <Link href="/solutions/cloud-migration" className="inline-flex items-center text-[#0052CC] font-medium hover:underline">
                  Daha Fazla Bilgi
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all w-full mx-auto">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-semibold text-[#253858] mb-3">Eğitim ve Sertifikasyon</h3>
                <p className="text-[#42526E] mb-4">Ekibinizin Atlassian ürünlerini etkili bir şekilde kullanması için özelleştirilmiş eğitim programları ve sertifikasyon hazırlık kursları sunuyoruz. Uygulamalı eğitimlerle verimliliği artırın.</p>
                <Link href="/solutions/training" className="inline-flex items-center text-[#0052CC] font-medium hover:underline">
                  Daha Fazla Bilgi
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                  </svg>
      ...
      <section className="w-full py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center mb-12">
            <span className="text-blue-200 font-bold tracking-widest mb-4">SON</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-blue-800 to-blue-900 rounded-3xl p-1 hover:from-blue-400 hover:to-blue-500 transition-all duration-300 w-5/6 mx-auto lg:w-full">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  AI destekli altyapı çözümlerimizle süreçlerinizi otomatikleştirin ve verimliliğinizi artırın.
                </p>
                  <Link href="/products/rovo" className="inline-flex items-center text-blue-300 font-bold group-hover:text-white">
                  Keşfet
            ...
            <div className="group bg-gradient-to-br from-blue-800 to-blue-900 rounded-3xl p-1 hover:from-blue-400 hover:to-blue-500 transition-all duration-300 w-5/6 mx-auto lg:w-full">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-white">Bulut Çözümleri</h3>
                  <p className="text-blue-200">
                  Modern bulut altyapısı ile işletmenizi geleceğe taşıyın, maliyetlerinizi optimize edin.
                </p>
                  <Link href="/solutions/consulting" className="inline-flex items-center text-blue-300 font-bold group-hover:text-white">
                  Keşfet
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
            ...
            <div className="group bg-gradient-to-br from-blue-800 to-blue-900 rounded-3xl p-1 hover:from-blue-400 hover:to-blue-500 transition-all duration-300 w-5/6 mx-auto lg:w-full">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-white">IT Desteği</h3>
                  <p className="text-blue-200">
                  7/24 uzman IT desteği ile sistemlerinizin sorunsuz çalışmasını sağlayın.
                </p>
                  <Link href="/solutions/it-support" className="inline-flex items-center text-blue-300 font-bold group-hover:text-white">
                  Keşfet
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-2 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col items-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-[#172B4D] text-center mb-6 leading-tight">
              Son <span className="bg-gradient-to-r from-[#0052CC] to-[#004BB3] bg-clip-text text-transparent">Yazılar</span>
            </h2>
            <p className="text-lg text-[#42526E] max-w-3xl text-center leading-relaxed">
              Dijital dönüşüm, Atlassian ve teknoloji dünyasından son içerikler
            </p>
          </div>
          ...
          <div className="flex justify-center mt-16">
            <Link href="/blog" className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-[#0052CC] to-[#004BB3] text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <StructuredData
        type="service"
        serviceData={{
          name: 'Virtual Riddle Atlassian Danışmanlık',
          description: 'Tüm Atlassian ürünleri için kurumsal danışmanlık hizmetleri, öncelikle Jira ve Confluence',
          url: 'https://virtualriddle.com',
          offers: [
            {
              name: 'Atlassian Danışmanlık',
              description: 'Jira, Confluence ve diğer Atlassian ürünleri ile iş süreçlerinizi optimize edin'
            },
            {
              name: 'Bulut Geçişi',
              description: 'Şirket içi Atlassian ürünlerinizi sorunsuz bir şekilde Bulut ortamına geçirin'
            },
            {
              name: 'Eğitim ve Sertifikasyon',
              description: 'Ekibinizin Atlassian ürünlerini etkili kullanması için özelleştirilmiş eğitim programları'
            }
          ]
        }}
      />
